					...
					kumpulanFilm += `<div class="col col-sm-6 col-md-4 col-lg-3">
                                    <div class="card p-3" >
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary btn-detail" data-id = "${film.imdbID}">Lihat Detail</a>
                                        </div>
                                    </div>
                                </div>`;
				});
...
function getMessageError() {
	...
	boxError.classList.add("alert", "alert-danger");
	boxError.setAttribute("role", "alert");
	boxError.innerText = `Nama film yang anda masukkan kurang spesifik !!!`;
